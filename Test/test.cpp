...
Moka::Context test("\nMars testing!", [](Moka::Context& it) {
  ...
  it.has("\nMath functions testing", [](Moka::Context& it) {
    ...
    it.should("addDigits function", []() {
        must_equal(addDigits(954), 18);
        must_equal(addDigits(14), 5);
        must_equal(addDigits(111), 3);
        must_equal(addDigits(654), 15);
        must_equal(addDigits(1234), 10);
      });
